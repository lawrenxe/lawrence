...
const EducationItem = ({ education }: EIProps) => {
  return (
    <div className="z-0 flex flex-col w-full gap-2 mb-4 bg-white p-3 lg:p-5 xl:p-8 border-black border-2 shadow-solid-4 rounded-lg">
      ...
      <img
        className="-mt-24 w-24 -z-10 aspect-square bg-white opacity-30 self-end"
        src={unimelb}
        alt="Unimelb Logo"
      />
    </div>
